            ...
            <div className="py-6">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            <h2 className="text-3xl font-bold tracking-tight">Add New Exam</h2>
                            <p className="text-muted-foreground">Create a new exam or assessment</p>
                        </div>
                    </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Enter the exam information</CardDescription>
                        </CardHeader>
                        <CardContent>
